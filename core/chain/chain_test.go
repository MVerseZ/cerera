...
func TestGetBlock(t *testing.T) {
	...
	if nonExistingBlock != nil {
		t.Fatalf("Non-existing block should return nil, got hash %s", nonExistingBlock.GetHash().Hex())
	}
}
...
func TestGetBlockHeader(t *testing.T) {
	...
	if nonExistingHeader != nil {
		t.Fatalf("Non-existing block header should return nil, got index %d", nonExistingHeader.Index)
	}
}
