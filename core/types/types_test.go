...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		{"0xb6053F3E94C9B9A09F33669435E7EF1bEAed", "0xb6053F3e94C9B9a09F33669435e7EF1bEAeD"},
		...
		{"0x2222222222222222222222222222222222222234", "0x2222222222222222222222222222222222222234"},
		{"0xa", "0xA"},
		{"0x0a", "0xA"},
		{"0x00a", "0xA"},
		{"0x00000000000000000000000000000000000a", "0xA"},
	}
	for i, test := range tests {
