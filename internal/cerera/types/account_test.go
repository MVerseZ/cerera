...
func TestStateAccount_Root(t *testing.T) {
	roots := []common.Hash{
		common.Hash{0x0},
		common.Hash{0xff, 0xff, 0xff, 0xff},
		common.Hash{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8},
...
func TestStateAccount_Passphrase(t *testing.T) {
	passphrases := []common.Hash{
		...
		common.Hash{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10,
